...
public class App {
    ...
    private void sendBucks() {
		...
		try {
			...
			int toUserId = Integer.parseInt(console.getUserInput("Enter ID of user you are sending to (0 to cancel) "));

			if (toUserId != 0) {

				BigDecimal amount = BigDecimal.valueOf(Double.parseDouble(console.getUserInput("Enter amount ")));
